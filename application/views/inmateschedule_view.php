                                    ...
                                    <div class="col-lg-12">
                                        <?php echo form_open(current_url_full(), 'class="form-horizontal" style="margin-top: 30px;"'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <?php echo form_input('schedule', set_value('schedule') ? set_value('schedule') : mdate("%m/%d/%Y %h:%i %A",strtotime($appearance_info->date)), 'id="schedule" class="form-control" required'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <?php
                                                        // $statuses = array('Pending' => 'Pending','Started' => 'Started','Finished'=>'Finished');
                                                    $statuses = array('Pending' => 'Pending','Finished'=>'Finished');
                                                        if ($appearance_info->status == 'Pending') {
                                                            $statuses['Postpone'] = 'Postpone';
                                                        }

                                                        // if ($appearance_info->status == 'Started') {
                                                        //     $statuses = array();
                                                        //     $statuses['Started'] = 'Started';
                                                        // }

                                                        if ($appearance_info->status == 'Finished') {
                                                            $statuses = array();
                                                            $statuses['Finished'] = 'Finished';
                                                        }

                                                        if ($appearance_info->status == 'Postpone') {
                                                            $statuses = array();
                                                            $statuses['Postpone'] = 'Postpone';
                                                        }
                                                    ?>
                                                    <?php echo form_dropdown('status',$statuses, set_value('status') ? set_value('status') : $appearance_info->status, 'id="status" class="form-control"'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="place" class="col-sm-2 control-label">Place</label>
                                                <div class="col-lg-7">
                                                   <!--  <?php echo form_input('place', set_value('place') ? set_value('place') : $appearance_info->place, 'id="place" class="form-control" required'); ?> -->
                                                   <?php $c = array();
                                                ...
                                                <?php 
                                                    ...
                                                    foreach ($courts as $court) {
                                                         ...
                                                         $c = array_merge($c,$data);
                                                            ...
                                                            ?>
                                                    <?php echo form_dropdown('ac1',$c,$appearance_info->assistedCourt, 'id="ac1" class="form-control"'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                 ...
                                                 $c = array_merge($c,$data);
                                                    foreach ($courts as $court) {
                                                         ...
                                                         $c = array_merge($c,$data);
                                                            ...
                                                            ?>
                                                    <?php echo form_dropdown('ac2',$c, ($appearance_info->assistingCourt!="None") ? $appearance_info->assistingCourt : '', 'id="ac2" class="form-control"'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="judge" class="col-sm-2 control-label">Handling Judge</label>
                                                <div class="col-lg-7">
                                                    <?php echo form_input('judge', set_value('judge') ? set_value('judge') : $judge, 'id="judge" class="form-control"'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="lawyers" class="col-sm-2 control-label">Lawyers</label>
                                                <div class="col-lg-7">
                                                    <?php echo form_input('lawyers', set_value('lawyers') ? set_value('lawyers') : $lawyers, 'id="lawyers" class="form-control"'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="jail_officer" class="col-sm-2 control-label">Assisting Jail Officer</label>
                                                <div class="col-lg-7">
                                                    <?php echo form_input('jail_officer', set_value('jail_officer') ? set_value('jail_officer') : $jail_officers, 'id="jail_officer" class="form-control"'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="remarks" class="col-sm-2 control-label">Remarks</label>
                                                <div class="col-lg-7">
                                                    <?php echo form_textarea('remarks', set_value('remarks') ? set_value('remarks') : $appearance_info->remarks, 'id="remarks" class="form-control" style="height: 100px;"'); ?>
                                                </div>
                                            </div>
                                            <div id="timeInfo" class="form-group">
                                                <label for="time_departed" class="col-sm-2 control-label">Time Departed</label>
                                                <div class="col-lg-2">
                                                    <?php echo form_input('time_departed', set_value('time_departed') ? set_value('time_departed') : mdate("%h:%i %A",strtotime($appearance_info->time_departed)), 'id="time_departed" class="form-control"'); ?>
                                                </div>
                                            
                                                <label for="time_returned" class="col-sm-2 control-label">Time Returned</label>
                                                <div class="col-lg-2">
                                                    <?php echo form_input('time_returned', set_value('time_returned') ? set_value('time_returned') : mdate("%h:%i %A",strtotime($appearance_info->time_returned)), 'id="time_returned" class="form-control"'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
<?php if ($appearance_info->status == 'Finished'): ?>
