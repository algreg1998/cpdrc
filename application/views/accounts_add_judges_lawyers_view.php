                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open(current_url_full(), 'class="form-horizontal"'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php $positions = array('judge'=>'Judge','lawyer'=>'Lawyer') ?>
                                <?php echo form_dropdown('position', $positions, set_value('position') ? set_value('position') : 'judge', 'id="position" class="form-control"'); ?>
                            </div>
                        </div>
                        <div class="form-group">
