$(function(){
	...
	$(".delCase").click(function()
	{
		...
		alertify.prompt("Are you sure you want to "+type+" <strong>"+item+"</strong>?<br>Please provide a reason for deleting and list of documentation(s)", function (e, str) {
	        reason = str;
	        ...
	        if (e) {
	            if (str == "") {
	                ...
	                alertify.alert("Please provide a reason for deleting and list of documentation(s)");
	                return false;
	            }else{
	                alertify.set({ labels: {
	                    ok     : "Yes, I'm sure",
