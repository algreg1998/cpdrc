                        ...
                        <div class="col-lg-12">
                            <?php echo form_open(current_url_full(), 'class="form-horizontal" style="margin-top: 30px;"'); ?>
                                ...
                                <div class="hidden form-group">
                                    ...
                                    <div class="col-lg-7">
                                    <?php echo form_input('cellId', set_value('cellId') ? set_value('cellId') : $cellId, 'id="cellId" class="form-control" required'); ?>
<!-- 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                    <?php echo form_input('cellNumber', set_value('cellNumber') ? set_value('cellNumber') : $cellNumber, 'id="cellNumber" class="form-control" required'); ?>
<!-- 
                                        <?php echo form_input('cellNumber', set_value('cellNumber') ? set_value('cellNumber') : '', 'id="cellNumber" class="form-control" required'); ?> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <!-- <?php echo form_input('capacity',$capacity,set_value('capacity') ? set_value('capacity') : '', 'id="capacity" class="form-control" required '); ?> -->
                                        <?php echo form_input('capacity', set_value('capacity') ? set_value('capacity') : $capacity, 'id="capacity" class="form-control" required'); ?>
