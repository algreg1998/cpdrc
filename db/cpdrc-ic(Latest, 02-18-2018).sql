...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2018 at 04:49 PM
...
('f2f376ea5a7b85dbabb486dac262f548', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.3; Win64; x64; rv:58.0) Gecko/20100101 Firefox/58.0', 1518968982, '');
...
CREATE  VIEW `view_court`  AS  select `a`.`court_id` AS `court_id`,concat(`a`.`court_name`,', ',`b`.`mun_name`) AS `court_name` from (`court` `a` join `municipality` `b` on((`a`.`court_mun` = `b`.`mun_id`))) ;
