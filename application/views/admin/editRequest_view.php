            ...
            <div class="panel panel-green">
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="table-editReqs">
                            <thead>
                                <tr>
                                    <th>Request # </th>
                                    <th>Inmate ID</th>
                                ...
                                <tr>
                                    ...
                                    <td id="stat-<?php echo $d->editRequestID; ?>">
                                        <?php if($d->status =="approved"){?>
                                            <label class="label label-success" style="font-size: 100%;"><?php echo ucwords($d->status); ?></label>
                                        <?php }?>
                                        <?php if($d->status =="pending"){?>
                                            <label class="label label-default" style="font-size: 100%;"><?php echo ucwords($d->status); ?></label>
                                        <?php }?>
                                        <?php if($d->status =="rejected"){?>
                                            <label class="label label-danger" style="font-size: 100%;"><?php echo ucwords($d->status); ?></label>
                                        <?php }?>
                                        <?php if($d->status =="finished"){?>
                                            <label class="label label-primary" style="font-size: 100%;"><?php echo ucwords($d->status); ?></label>
                                        <?php }?>
                                    </td>
                                        <?php if($d->status =="pending"){?>
